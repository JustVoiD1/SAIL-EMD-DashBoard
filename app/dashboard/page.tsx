    ...
    <div className="min-h-screen bg-background/50">
      ...
      <header className='sticky top-0 z-50'>
        ...
        <div className="bg-card/50 backdrop-blur-sm border-b border-border">
          {/* Global Stats Topbar */}
          <div className="w-[97vw] mx-auto p-2">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <button
                ...
                className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-sm transition-colors flex items-center gap-2"
              >
                <CreateIcon /> <span>Create</span>
              </button>
            </div>
            <div className=' searchbarline flex justify-between items-center'>
              <Input
