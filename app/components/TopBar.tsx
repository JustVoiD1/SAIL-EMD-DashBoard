            ...
            <div className="flex items-center space-x-2 lg:space-x-4">
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    className="py-3 px-4 text-center text-foregroud text-xs rounded-full bg-card border border-neutral-300 hover:bg-background/30 transition-all duration-300 hover:scale-110"
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className="p-2 rounded-lg bg-background/20 border border-neutral-400 hover:bg-background/30 transition-all duration-300 hover:scale-110 hover:rotate-12"
