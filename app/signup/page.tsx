    ...
    const onSubmit: SubmitHandler<Inputs> = async (data) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                document.cookie = `token=${result.token}; path=/; max-age=86400`; // 24 hours
            ...
            <div className="bg-card/10 backdrop-blur-lg border border-border rounded-2xl shadow-2xl p-8 w-full max-w-md mx-4 transform transition-all duration-300 hover:scale-[1.02]">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="flex items-center justify-between text-sm">
                        ...
                        <Link href="/signin" className="text-blue-400 hover:text-blue-300 transition-colors duration-200">
